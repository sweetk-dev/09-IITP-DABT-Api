...
-- #### 산업별 의무고용 현황 테이블 ####
-- # public.emp_dis_industry_obligation definition

DROP TABLE IF EXISTS public.emp_dis_industry_obligation;

CREATE TABLE public.emp_dis_industry_obligation (
    id int4 GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- 시스템 ID
    year int NOT NULL, -- 연도
    industry varchar(100) NOT NULL, -- 업종
    company_count int NOT NULL, -- 사업체수
...
CREATE INDEX idx_emp_dis_industry_obligation_year ON public.emp_dis_industry_obligation (year);
CREATE INDEX idx_emp_dis_industry_obligation_industry ON public.emp_dis_industry_obligation (industry);

COMMENT ON TABLE public.emp_dis_industry_obligation IS '14. 산업별 의무고용 현황 테이블';
COMMENT ON COLUMN public.emp_dis_industry_obligation.id IS '시스템 ID';
COMMENT ON COLUMN public.emp_dis_industry_obligation.year IS '연도';
COMMENT ON COLUMN public.emp_dis_industry_obligation.industry IS '업종';
COMMENT ON COLUMN public.emp_dis_industry_obligation.company_count IS '사업체수';
COMMENT ON COLUMN public.emp_dis_industry_obligation.worker_count IS '근로자수';
COMMENT ON COLUMN public.emp_dis_industry_obligation.obligation_count IS '의무고용인원';
COMMENT ON COLUMN public.emp_dis_industry_obligation.emp_rate IS '고용률 (%)';
COMMENT ON COLUMN public.emp_dis_industry_obligation.created_at IS '생성시각';
COMMENT ON COLUMN public.emp_dis_industry_obligation.updated_at IS '수정시각';
COMMENT ON COLUMN public.emp_dis_industry_obligation.created_by IS '데이터 생성자';
COMMENT ON COLUMN public.emp_dis_industry_obligation.updated_by IS '데이터 수정자';
