...
-- ## ver 0.0.2 last update data : 2025.07.08
-- ## Only for PostgreSQL
...
CREATE TABLE public.emp_dis_jobseeker_status (
                                                 ...
                                                 region varchar(100), -- 희망지역 (예: 서울 영등포구, 강원 원주시)
...
CREATE INDEX idx_emp_dis_industry_obligation_year_industry ON public.emp_dis_industry_obligation (year, industry);
