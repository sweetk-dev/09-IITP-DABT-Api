...
-- ## ver 0.0.8 last update data : 2025.06.23
-- ## Only for PostgreSQL
-- ## Except "mv_poi" table
...
CREATE TABLE public.stats_src_data_info (
	api_cli_id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 CYCLE) NOT NULL, -- system id, 고유 식별자 (자동 증가)
