...
-- ## ver 0.1.1 last update data : 2025.06.25
-- ## Only for PostgreSQL
...
CREATE TABLE public.sys_stats_src_api_info (
	...
	api_data_url varchar(600) NOT NULL, -- 연동할 stas data API URL Inof(json {"url":, "format":}), {API_AUTH_KEY}를 실제 Key로 치환 
...
COMMENT ON COLUMN public.sys_stats_src_api_info.api_data_url IS '연동할 stas data API URL Inof(json {"url":, "format":}), {API_AUTH_KEY}를 실제 Key로 치환';
