...
@Repository
public interface EmpDisJobPostingRepository extends JpaRepository<EmpDisJobPostingEntity, Integer> {
     ...
     * 전체 조회 (순번순)
     */
    @Query("SELECT e FROM EmpDisJobPostingEntity e ORDER BY e.seqNo")
    List<EmpDisJobPostingEntity> findAllOrderBySeqNo();
} 