...
public class StatsDisEmpNatlDisTypeSevRepositoryImpl extends BasicQuerySupport implements StatsDisEmpNatlDisTypeSevRepositoryCustom {
    private final JPAQueryFactory queryFactory;

    @Override
    public List<StatDataItemDB> findDataLatest(StatsSrcDataInfoEntity srcDataInfo, Integer fromYear) {
        QStatsDisEmpNatlDisTypeSevEntity qEntity = QStatsDisEmpNatlDisTypeSevEntity.statsDisEmpNatlDisTypeSevEntity;
