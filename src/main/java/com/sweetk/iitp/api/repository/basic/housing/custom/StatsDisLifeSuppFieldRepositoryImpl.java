...
public class StatsDisLifeSuppFieldRepositoryImpl extends BasicRepositoryQuerySupport implements StatsDisLifeSuppFieldRepositoryCustom {
    private final JPAQueryFactory queryFactory;

    @Override
    public List<StatDataItemDB> findDataLatest(StatsSrcDataInfoEntity srcDataInfo, Integer fromYear) {
        QStatsDisLifeSuppFieldEntity qEntity = QStatsDisLifeSuppFieldEntity.statsDisLifeSuppFieldEntity;
